"""
Django settings for gestion_grandeurs project.
...
SECRET_KEY = 'django-insecure-6r7&l=u#qwlwl*r6jv&e#@ff$zq5k$)u)!uz&%odmgq)&+%td-'
...
ROOT_URLCONF = 'gestion_grandeurs.urls'
...
WSGI_APPLICATION = 'gestion_grandeurs.wsgi.application'
